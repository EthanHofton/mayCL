...
namespace mayCL
{
    ...
    // core logger macros
    #define CORE_TRACE(...) Logger::instance()->coreTrace(__VA_ARGS__)
    #define CORE_DEBUG(...) Logger::instance()->coreDebug(__VA_ARGS__)
    #define CORE_INFO(...) Logger::instance()->coreInfo(__VA_ARGS__)
    #define CORE_WARN(...) Logger::instance()->coreWarn(__VA_ARGS__)
    #define CORE_ERROR(...) Logger::instance()->coreError(__VA_ARGS__)
    #define CORE_CRITICAL(...) Logger::instance()->coreCritical(__VA_ARGS__)

    // client logger macros
    #define APP_TRACE(...) Logger::instance()->trace(__VA_ARGS__)
    #define APP_DEBUG(...) Logger::instance()->debug(__VA_ARGS__)
    #define APP_INFO(...) Logger::instance()->info(__VA_ARGS__)
    #define APP_WARN(...) Logger::instance()->warn(__VA_ARGS__)
    #define APP_ERROR(...) Logger::instance()->error(__VA_ARGS__)
    #define APP_CRITICAL(...) Logger::instance()->critical(__VA_ARGS__)
}
